...
import (
	...
	"github.com/kotleta/go-admin/modules/collection"
	"github.com/kotleta/go-admin/modules/config"
	"github.com/kotleta/go-admin/modules/db"
	"github.com/kotleta/go-admin/modules/db/dialect"
	errs "github.com/kotleta/go-admin/modules/errors"
	"github.com/kotleta/go-admin/modules/language"
	"github.com/kotleta/go-admin/modules/logger"
	"github.com/kotleta/go-admin/modules/ui"
	"github.com/kotleta/go-admin/modules/utils"
	"github.com/kotleta/go-admin/plugins/admin/models"
	form2 "github.com/kotleta/go-admin/plugins/admin/modules/form"
	"github.com/kotleta/go-admin/plugins/admin/modules/parameter"
	"github.com/kotleta/go-admin/plugins/admin/modules/tools"
	"github.com/kotleta/go-admin/template"
	"github.com/kotleta/go-admin/template/types"
	"github.com/kotleta/go-admin/template/types/action"
	"github.com/kotleta/go-admin/template/types/form"
	selection "github.com/kotleta/go-admin/template/types/form/select"
...
func (s *SystemTable) GetGenerateForm(ctx *context.Context) (generateTool Table) {
	...
	formList.AddField(lgWithScore("extra import package", "tool"), "extra_import_package", db.Varchar, form.Select).
		FieldOptions(types.FieldOptions{
			...
			{Text: "log", Value: "log"},
			{Text: "fmt", Value: "fmt"},
			{Text: "github.com/kotleta/go-admin/modules/db/dialect", Value: "github.com/kotleta/go-admin/modules/db/dialect"},
			{Text: "github.com/kotleta/go-admin/modules/db", Value: "github.com/kotleta/go-admin/modules/db"},
			{Text: "github.com/kotleta/go-admin/modules/language", Value: "github.com/kotleta/go-admin/modules/language"},
			{Text: "github.com/kotleta/go-admin/modules/logger", Value: "github.com/kotleta/go-admin/modules/logger"},
		}).
		FieldDefault("").
